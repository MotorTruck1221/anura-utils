        ...
        this.element = (h("div", { class: "aliceWMwin opacity0", style: `
            ...
            h("div", { class: "title", "on:pointerdown": (evt) => {
                ...
                h("button", { class: "windowButton minimize", "on:click": () => {
                    ...
                    h("img", { src: "/assets/window/minimize.svg", height: "12px", class: "windowButtonIcon" })),
                h("button", { class: "windowButton maximize", "on:click": this.maximize.bind(this) }, (this.maximizeImg = (h("img", { src: "/assets/window/maximize.svg", height: "12px", class: "windowButtonIcon" })))),
                h("button", { class: "windowButton close", "on:click": this.close.bind(this) },
                    h("img", { src: "/assets/window/close.svg", height: "12px", class: "windowButtonIcon" }))),
...
async function normalizeZindex() {
    ...
    for (const wmwindow of allWindows) {
        wmwindow.style.setProperty("z-index", (Number(wmwindow.style.getPropertyValue("z-index")) -
