            ...
            h("div", { class: ["quickSettingsContent"] },
                h("div", { class: ["topButtons"] },
                    h("button", { class: ["matter-button-contained", "symbolButton"], title: "Exit anuraOS", "on:click": () => {
                            window.location.replace(anura.settings.get("exitUrl") ||
                                "https://google.com/");
                        } },
                    ...
                    h("button", { class: ["matter-button-contained", "symbolButton"], "on:click": () => {
                        ...
                        h("span", { class: ["material-symbols-outlined"] }, use(anura.platform.state.fullscreen, (fullscreen) => fullscreen
                            ? "fullscreen_exit"
                            : "fullscreen")))),
                h("div", { class: ["quickSettingsPinned"] }, use(this.state.pinnedSettings, (pinnedSettings) => {
                    const settingsElements = [];
                    for (let i = 0; i < pinnedSettings.length; i++) {
                        settingsElements.push(h("div", { class: "pinnedSetting", title: this.state.pinnedSettings[i]
                                .description, "on:click": () => {
                                anura.settings.set(this.state.pinnedSettings[i]
                                    .registry, !anura.settings.get(this.state.pinnedSettings[i].registry));
                                this.state.pinnedSettings[i].value = anura.settings.get(this.state.pinnedSettings[i]
                                    .registry);
                                this.state.pinnedSettings =
                                    pinnedSettings;
                                if (this.state.pinnedSettings[i]
                                    .onChange) {
                            ...
                            h("button", { class: [
                                ...
                                h("span", { class: "material-symbols-outlined" }, this.state.pinnedSettings[i]
                                    .icon || "settings")),
