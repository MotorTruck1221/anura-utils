            ...
            h("div", { "bind:this": use(this.state.settingsBody), class: "settings-body" },
                h("div", { id: "general", class: "general settings-category" },
                    ...
                    h("div", { class: "settings-group" },
                        h(SettingSwitch, { title: "Allow offline use", setting: "use-sw-cache", callback: () => {
                    ...
                    h("div", { class: "settings-group" }, this.state.show_x86_install ? (h("div", null,
                        h("button", { "on:click": async () => {
                                ...
                                if (document.getElementById("tracker")) {
                                    document.getElementById("tracker").innerText = "Installed!";
                                }
                        ...
                        h("div", { class: "settings-item" },
                            h("div", { class: "disk-info" },
                                ...
                                h("input", { class: "settings-item-text-input disk-size-bytes", id: "disk-size-bytes", value: Math.ceil(anura.x86hdd.size /
                                        1000000) || 0, type: "text" })),
                            h("button", { "on:click": async () => {
                                    ...
                                    if (document.getElementById("resize-disk-btn")) {
                                        document.getElementById("resize-disk-btn").innerText =
                                            "Resizing...";
                                    }
                                        ...
                                        inp.addEventListener("change", async () => {
                                            if (inp.files) {
                                                if (inp.files[0]) {
                                                    try {
                                                        // @ts-ignore
                                                        await anura.x86hdd.loadfile(inp
                                                            .files[0]);
                                                        anura.notifications.add({
                                                        ...
                                                        anura.dialog.alert("Error loading file: " +
                                                            e);
                                                    }
                                                }
                                            }
